...
public abstract class SendKinServiceBase extends Service {
    ...
    public abstract KinTransferComplete transferKin(@NonNull final String senderAppId, @NonNull final String senderAppName, @NonNull final String toAddress, final int amount, @NonNull final String memo) throws KinTransferException;

    public void transferKinAsync(@NonNull final String senderAppId, @NonNull final String senderAppName, @NonNull final String toAddress, final int amount, @NonNull final String memo, @NonNull KinTransferCallback callback){}
