...
class TransferAmountActivity : AppCompatActivity(), ITransferAmountView {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        presenter = TransferAmountPresenter(appName, DeviceUtils.getApplicationName(baseContext), receiverPublicAddress, EcosystemAppsRepository.getInstance(packageName, EcosystemAppsLocalRepo(this), EcosystemAppsRemoteRepo(), Handler(Looper.getMainLooper())), SenderServiceBinder(this))
