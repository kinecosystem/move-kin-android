    ...
    override fun onSendKinClicked() {
        ...
        app?.let { application ->
            application.identifier?.let { receiverPackage ->
                senderServiceBinder.startSendKin(receiverPublicAddress, application.name, amountToSend, application.getTransactionMemo(), receiverPackage)
